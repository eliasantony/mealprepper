...
import { ChefHat, Calendar, Settings, Menu, X, BookOpen } from 'lucide-react';
        ...
        <header className="glass sticky top-0 z-50 border-b border-border">
            <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                ...
                <nav className="hidden md:flex items-center gap-1">
                    ...
                    >
                        <Settings className={cn("w-4 h-4", isActive('/settings') ? "text-orange-500" : "")} />
                        <span>Settings</span>
                    </Link>
                </nav>
                    ...
                    >
                        <nav className="flex flex-col p-4 gap-2">
                            ...
                            <Link
                                ...
                                className={cn(
                                    "flex items-center gap-3 px-4 py-3 rounded-lg transition-colors",
                                    isActive('/settings') ? "text-foreground bg-secondary" : "text-muted-foreground hover:text-foreground hover:bg-secondary/50"
                                )}
                            >
                                <Settings className={cn("w-5 h-5", isActive('/settings') ? "text-orange-500" : "")} />
                                <span>Settings</span>
                            </Link>
                        </nav>
                    </motion.div>
